...
上面会出现，如果只改动一点点文件，提交也会对所有文件执行`eslint --fix`操作。所以可以使用`lint-staged`来将`husky`的触发变成只作用于 git 暂存区的文件（即`git add`的文件），而不会影响其他文件。
...
3. 更换为`git cz`提交代码（将`git cz`添加到`scripts`中后再执行）
   ![](https://www.clzczh.top/CLZ_img/images/20250323113343.png)
...
![](https://www.clzczh.top/CLZ_img/images/20250323113511.png)
...
![](https://www.clzczh.top/CLZ_img/images/20250323113529.png)
...
![](https://www.clzczh.top/CLZ_img/images/20250323113608.png)
